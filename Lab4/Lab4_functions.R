...
#  В результате функции c1(), c2() работают как полностью независимые счетчики.



# -------------------------------- 
# Практическое задание по итогам лабораторной работы:
# напишите функцию, которая:
# 1) прочитает .txt-файл (создайте его, напишите внутри строку - Лабораторная работа №3), используйте команду read.table()
# 2) прочитает текст из консоли (команда input())
# 3) сохранит эти данные в дата-фрейм
# 4) выведет его на печать в консоль командой print()
# 5) закомитьте изменения в своем локальном Гит-репозитории
# 6) запушьте изменения в своем улаленном облачном Гит-репозитории


# --------------------- 
# напишите функцию, которая выполнит преобразования ниже в несколько шагов:
# 1) создайте 5шт txt-файлов с числовыми значениями внутри
# 2) прочитайте каждый и запишите в виде переменной по имени X. У вас должно быть именно 5шт переменных под одинаковым названием.
# Подсказка - см.тему окружений
# 3) проитерируйте эти 5шт переменных в цикле и создайте один (!) график, который выведет числовые значения
# 4) объедините 5шт строк в дата-фрейм, выведите получившийся объект в консоль
#
